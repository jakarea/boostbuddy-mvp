...
interface ClientNotificationsClientProps {
  initialLogs: NotificationLogDTO[];
}

export default function ClientNotificationsClient({ initialLogs }: ClientNotificationsClientProps) {
  ...
  const goToPage = (page: number) => {
    ...
    router.push(`/c/notifications?${params.toString()}`);
    setCurrentPage(page);
  };
