                      ...
                      <TableRow key={ord.id} className="border-b border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50/50 dark:hover:bg-zinc-900/50">
                        ...
                        <TableCell className="text-xs">
                          <div
                            ...
                            onClick={() => router.push(`/a/clients?id=${ord.user_id}`)}
                          >
                        ...
                        <TableCell className="text-xs font-medium">
                          <span
                            ...
                            onClick={() => { if (ord.service_id) router.push(`/a/services?action=edit&id=${ord.service_id}`); }}
                          >
                        ...
                        <TableCell className="text-xs">
                          {linkedProfile ? (
                            <div
                              ...
                              onClick={() => router.push(`/a/profiles?action=edit&id=${ord.profile_account_id}`)}
                            >
