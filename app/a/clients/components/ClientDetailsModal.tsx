...
import { updateBillingInfoAction, updateClientStatusAction, updateClientNotesAction, approveClientAndVerifyEmailAction, verifyClientEmailAction, updateUserRoleAction } from "@/app/actions/clients";
...
export default function ClientDetailsModal({
  ...
  const handleRoleChange = (newRole: "ADMIN" | "CLIENT" | "EMPLOYEE") => {
    if (newRole === userRole) return; // No change needed
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        ...
        // If role changed from non-CLIENT to CLIENT, redirect to client registry
        setTimeout(() => {
          if (newRole === "CLIENT") {
              ...
              <div className="flex justify-between items-center text-xs pt-3 border-t border-zinc-100 dark:border-zinc-800">
                ...
                <div className="flex items-center gap-2">
                  {roleUpdating ? (
                    ...
                    >
                      <SelectTrigger className="h-7 w-28 text-xs bg-zinc-50 dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent className="bg-zinc-50 dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800">
