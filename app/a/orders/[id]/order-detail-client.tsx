    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <Card className="p-5 bg-gradient-to-r from-zinc-50 to-blue-50 dark:from-zinc-900 dark:to-blue-900/20">
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div className="flex-1 min-w-[180px]">
              <p className="text-xs text-zinc-500 dark:text-zinc-400 uppercase tracking-wide font-semibold mb-1">
                {t("orders.table_employee", "Assigned Employee")}
              </p>
        ...
        {order.reviewInstructions && (
          <Card className="p-4 bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-sm">{t("orders.instructions", "Instructions")}</h3>
            </div>
        ...
        {order.clientFeedback && (
          <Card className="p-4">
            <div className="flex items-center gap-2">
              <span className="text-sm text-zinc-500">{t("orders.client_feedback", "Client Feedback:")}</span>
              <Badge
                className={
